...
class Common_util_pub
{
	 ...
	 * 	ty add  for  https
	 */
	function postXmlCurl2($data,$url,$second=30)
	{ 
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function postXml()
	{
		...
		// $this->response = $this->postXmlCurl2($xml,$this->url,$this->curl_timeout);
...
/**
* JSAPI支付——H5网页端调起支付接口 $ 用户信息
*/
class JsApi_pub extends Common_util_pub
{
	var $code;//code码，用以获取openid
	var $openid;//用户的openid
	var $access_token;//网页授权接口调用凭证
	...
	/**
	 * 	作用：通过curl向微信提交openid,access_token，以获取userinfo
	 */
